# 📊 Nigeria-COVID-19-Household-Impact – Capstone Project

This project is part of my final certification for the **CWW Tech Africa Program**, designed to demonstrate my practical expertise in using **Power BI** to analyze the impact of COVID-19 on Nigeria household and provide actionable insights.
